...
RSpec.describe Merchant, type: :model do
  ...
  describe 'class methods' do
    ...
    it '#items_sold' do
      ...
      expect(Merchant.items_sold(3).length).to eq(3)
      expect(Merchant.items_sold(3).first).to eq(merch6)
      expect(Merchant.items_sold(3).last).to eq(merch4)
      expect(Merchant.items_sold.length).to eq(5)
      expect(Merchant.items_sold.first).to eq(merch6)
      expect(Merchant.items_sold.last).to eq(merch7)
    end
  end
